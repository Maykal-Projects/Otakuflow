...
>
        ...
        <h2 className="text-xs sm:text-xl font-black leading-tight line-clamp-2 min-h-[72px] max-h-[72px] overflow-hidden">
  {anime.title}
</h2>
...
>
  ...
  <button
    onClick={removeAnime}
    className="w-full mt-2 h-[50px] flex items-center justify-center gap-2 rounded-2xl bg-red-500/10 border border-red-500/20 hover:bg-red-500/20 transition font-semibold flex-shrink-0"
  >
    <Trash2 size={18} />
    Remove from Library
  </button>
