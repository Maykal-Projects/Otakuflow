...
Using this LibraryAnimeCard.tsx
We must fix the next problems.
In Library the card doesn't have a image
When anime is removed from favorites it recover itself when refreshing the page or change the page
Alsowe must sync progress, favorite and rating library to favorite and favorite to library
For example if rating on library is 10 on favorite too must change to 10 
