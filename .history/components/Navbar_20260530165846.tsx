...
const [mobileMenu, setMobileMenu] =
  ...
  <div className="absolute top-0 left-0 w-full z-50 flex justify-center pt-4 px-4">
    <nav className="w-full max-w-[1700px] overflow-visible rounded-3xl sm:rounded-[32px] border border-violet-500/20 bg-gradient-to-r from-violet-950/40 via-black/30 to-fuchsia-950/30 backdrop-blur-3xl shadow-[0_10px_80px_rgba(139,92,246,0.25)] relative">
...
<div className="sm:hidden">
  ...
  <div className="flex items-center justify-between">
    ...
    <h1 className="text-xl font-black bg-gradient-to-r from-violet-400 to-fuchsia-500 bg-clip-text text-transparent">
      Anime
    </h1>
    ...
    <button
      ...
      className="p-2 rounded-2xl border border-white/10 bg-white/[0.04] active:scale-95 transition"
    >
  ...
  {mobileMenu && (
    ...
    <div className="mt-4 flex flex-col gap-3 rounded-3xl border border-white/10 bg-black/90 backdrop-blur-3xl p-3 shadow-[0_20px_80px_rgba(0,0,0,0.45)]">
  ...
  className="relative z-50 p-2 rounded-xl border border-white/10 bg-white/[0.03] active:scale-95 transition"
>
        {mobileMenu ? (
          <X size={22} />
        ) : (
  ...
  <div className="mt-4 p-3 rounded-3xl border border-white/10 bg-black/95 backdrop-blur-3xl shadow-[0_20px_80px_rgba(0,0,0,0.55)]">
