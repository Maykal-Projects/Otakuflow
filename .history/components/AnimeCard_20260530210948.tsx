      ...
      <div className="relative overflow-hidden rounded-[28px] border border-white/10 bg-zinc-950/80 backdrop-blur-xl transition duration-500 group-hover:border-violet-500/50 group-hover:-translate-y-2 h-full flex flex-col">
        ...
        <div className="relative overflow-hidden">
          <img
            ...
            alt=""
            className="w-full h-[180px] sm:h-[380px] object-cover transition duration-700 group-hover:scale-110"
          />
          ...
          {/* Floating Score */}
          {anime.score && (
            <div className="absolute top-4 right-4 backdrop-blur-xl bg-black/50 border border-white/10 px-4 py-2 rounded-2xl">
          ...
          {/* Episodes */}
          <div className="absolute top-4 left-4 backdrop-blur-xl bg-black/50 border border-white/10 px-4 py-2 rounded-2xl">
  <p className="text-sm font-bold text-white">
    {anime.episodes
      ? `${anime.episodes} EP`
      : anime.airing
        ...
        <div className="p-5 flex flex-col flex-1">
          ...
          {/* Title */}
          className="text-base sm:text-xl font-black leading-tight line-clamp-3 min-h-[88px] mb-3 group-hover:text-violet-300 transition">
            {anime.title}
          </h2>
