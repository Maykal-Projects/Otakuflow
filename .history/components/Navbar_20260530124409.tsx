...
export default function Navbar() {
  ...
  <div className="absolute top-0 left-0 w-full z-50 flex justify-center pt-4 px-4">
    <nav className="w-full rounded-[32px] border border-violet-500/20 bg-gradient-to-r from-violet-950/40 via-black/30 to-fuchsia-950/30 backdrop-blur-3xl shadow-[0_10px_80px_rgba(139,92,246,0.25)] relative">
      ...
      {/* CONTENT */}
      <div className="relative px-3 sm:px-6 py-3 sm:py-4 flex flex-col items-center gap-3">

        {/* LEFT */}
        <div className="grid grid-cols-2 sm:flex items-center gap-2 sm:gap-3 w-full">
...
<div className="w-full">
  ...
  {!user && (
    <Link
      href="/login"
      className="w-full bg-violet-500/10 hover:bg-violet-500/20 border border-violet-500/20 px-4 sm:px-6 py-3 rounded-2xl font-semibold transition text-center"
    >
      Login
    </Link>
  )}
