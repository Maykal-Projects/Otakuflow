    ...
    >
      ...
      <div className="relative overflow-hidden rounded-2xl sm:rounded-[28px] border border-white/10 bg-zinc-950/80 backdrop-blur-xl transition duration-500 group-hover:border-violet-500/50 group-hover:-translate-y-2 h-full flex flex-col">
        ...
        <div className="relative overflow-hidden">
          ...
          {/* Floating Score */}
          {anime.score && (
            <div className="absolute top-2 right-2 sm:top-4 sm:right-4 backdrop-blur-xl bg-black/50 border border-white/10 px-4 py-2 rounded-2xl">
          ...
          {/* Episodes */}
          <div className="absolute top-2 left-2 sm:top-4 sm:left-4 backdrop-blur-xl bg-black/50 border border-white/10 px-4 py-2 rounded-2xl">
  <p className="text-sm font-bold text-white">
    {anime.episodes
      ? `${anime.episodes} EP`
      : anime.airing
