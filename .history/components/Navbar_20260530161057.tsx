...
const [mobileMenu, setMobileMenu] =
  ...
  return (
  <header className="fixed top-0 left-0 w-full z-[999999] flex justify-center pt-4 px-4">
  ...
  <div className="relative isolate z-[999999] px-3 sm:px-6 py-3 sm:py-4">
...
>
    ...
    {/* DROPDOWN */}
{mobileMenu && (
  <div className="absolute left-0 top-full mt-3 w-full z-[99999]">

    <div className="flex flex-col gap-3 rounded-3xl border border-white/10 bg-black/90 backdrop-blur-3xl p-3 shadow-[0_20px_80px_rgba(0,0,0,0.45)] animate-in fade-in slide-in-from-top-2 duration-300">
