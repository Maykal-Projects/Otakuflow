...
const [mobileMenu, setMobileMenu] =
  ...
  <header className="fixed top-0 left-0 w-full z-[9999] flex justify-center pt-4 px-4">
    <nav className="w-full max-w-[1700px] overflow-hidden rounded-3xl sm:rounded-[32px] border border-violet-500/20 bg-gradient-to-r from-violet-950/40 via-black/30 to-fuchsia-950/30 backdrop-blur-3xl shadow-[0_10px_80px_rgba(139,92,246,0.25)] relative">
