...
export default function LibraryAnimeCard({ anime, onRemove }: Props) {
  ...
  return (
    <div className="group relative w-[320px] min-w-[320px] max-w-[320px] h-[760px] rounded-2xl overflow-hidden border border-white/10 bg-zinc-900/80 backdrop-blur-xl">
      <div className="relative w-full h-[480px] overflow-hidden flex-shrink-0">
        <img
          src={anime.image}
          alt={anime.title}
      ...
      <div className="p-5 h-[280px] flex flex-col">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-black leading-tight line-clamp-2 h-[60px] overflow-hidden">
  {anime.title}
</h2>
        ...
        <button
          onClick={removeAnime}
          className="w-full h-[56px] flex items-center justify-center gap-2 rounded-2xl bg-red-500/10 border border-red-500/20 hover:bg-red-500/20 transition font-semibold flex-shrink-0" gap-2 py-3 rounded-2xl bg-red-500/10 border border-red-500/20 hover:bg-red-500/20 transition font-semibold"
        >
