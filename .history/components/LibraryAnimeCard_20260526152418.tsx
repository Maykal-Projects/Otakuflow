...
export default function LibraryAnimeCard({ anime, onRemove }: Props) {
  ...
  return (
    <div className="group relative w-[320px] min-w-[320px] max-w-[320px] h-[760px] rounded-2xl overflow-hidden border border-white/10 bg-zinc-900/80 backdrop-blur-xl">
      ...
      <div className="p-5 h-[340px] flex flex-col">
        <div className="flex items-center justify-between">
        <h2 className="text-xl font-black leading-tight h-[56px] overflow-hidden line-clamp-2">
  {anime.title}
</h2>
        ...
        <button
          onClick={removeAnime}
          className="mt-auto w-full h-[56px] flex items-center justify-center gap-2 rounded-2xl bg-red-500/10 border border-red-500/20 hover:bg-red-500/20 transition font-semibold flex-shrink-0"
        >
