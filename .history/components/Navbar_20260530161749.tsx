# Replace your entire Navbar.tsx with this
...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-[999999] px-4 pt-4">
      ...
      <nav className="mx-auto w-full max-w-[1700px] rounded-3xl border border-violet-500/20 bg-gradient-to-r from-violet-950/40 via-black/40 to-fuchsia-950/30 backdrop-blur-3xl shadow-[0_10px_80px_rgba(139,92,246,0.25)] overflow-visible relative">
