...
>
    ...
    {/* DROPDOWN */}
    {mobileMenu && (
  <div className="relative z-[99999] mt-4 flex flex-col gap-3 rounded-3xl border border-white/10 bg-black/80 backdrop-blur-3xl p-3 shadow-[0_10px_60px_rgba(0,0,0,0.45)] animate-in fade-in slide-in-from-top-2 duration-300">
