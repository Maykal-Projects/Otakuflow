...
export default function LibraryAnimeCard({ anime, onRemove }: Props) {
  ...
  {anime.title}
        ...
        <button
  onClick={removeAnime}
  className="mx-5 mt-6 h-[56px] flex items-center justify-center gap-2 rounded-2xl bg-red-500/10 border border-red-500/20 hover:bg-red-500/20 transition font-semibold flex-shrink-0"
>
  <Trash2 size={18} />
  Remove from Library
</button>
