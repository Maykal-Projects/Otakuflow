...
const [mobileMenu, setMobileMenu] =
  ...
  {/* MOBILE */}
  <div className="mt-4 flex flex-col gap-3 rounded-3xl border border-white/10 bg-black/40 backdrop-blur-3xl p-3 animate-in fade-in slide-in-from-top-2 duration-300">
