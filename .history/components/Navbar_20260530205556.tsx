...
export default function Navbar() {
  ...
  return (
    ...
    <div className="absolute top-4 left-1/2 -translate-x-1/2 z-50 w-[96%] max-w-[1700px]">
      ...
      <nav className="w-full <nav className="w-full overflow-hidden rounded-[999px] border border-violet-500/20 bg-gradient-to-r from-violet-950/40 via-black/30 to-fuchsia-950/30 backdrop-blur-3xl shadow-[0_10px_80px_rgba(139,92,246,0.25)] relative">
