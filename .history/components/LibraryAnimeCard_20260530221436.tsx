...
await supabase
  ...
  className={`group relative w-[180px] min-w-[180px] max-w-[180px] sm:w-[320px] sm:min-w-[320px] sm:max-w-[320px] rounded-2xl overflow-hidden border border-white/10 bg-zinc-900/80 backdrop-blur-xl ${
    hideRemoveButton
      ? "min-h-[450px] sm:min-h-[640px]"
      : "min-h-[520px] sm:min-h-[760px]"
  }`}
>
      <div
...
>
        ...
        <h2 className="text-xs sm:text-xl font-black leading-tight line-clamp-2 h-[56px] sm:h-[72px] overflow-hidden">
  {anime.title}
</h2>
...
>
  ...
  <button
    onClick={removeAnime}
    className="mt-auto w-full h-[44px] flex items-center justify-center gap-2 rounded-2xl bg-red-500/10 border border-red-500/20 hover:bg-red-500/20 transition font-semibold flex-shrink-0 text-sm" flex items-center justify-center gap-2 rounded-2xl bg-red-500/10 border border-red-500/20 hover:bg-red-500/20 transition font-semibold flex-shrink-0"
  >
