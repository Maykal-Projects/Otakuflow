...
export default function LibraryAnimeCard({ anime, onRemove }: Props) {
  ...
  return (
    <div className="group relative w-full max-w-[320px] h-[760px] rounded-2xl overflow-hidden border border-white/10 bg-zinc-900/80 backdrop-blur-xl">
      ...
      <div className="p-5 flex flex-col gap-2">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-black line-clamp-2 min-h-[64px]">{anime.title}</h2>
