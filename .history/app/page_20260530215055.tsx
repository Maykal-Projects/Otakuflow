...
function toggleGenre(
  ...
  return (
    <main className="relative z-0 min-h-screen bg-black text-white pt-28">
      <Navbar />
      ...
      <section className="relative pt-32 sm:pt-40 pb-20 sm:pb-24 px-4 sm:px-6">
        <div className="relative z-0 max-w-7xl mx-auto text-center overflow-visible">
          ...
          {/* SEARCH + FILTERS */}
          <div className="grid grid-cols-1 xl:grid-cols-[auto_1fr_auto] gap-4 lg:gap-6 max-w-7xl mx-auto w-full">
...
<option value="all">
  All
            ...
            <div className="relative w-full">
              ...
              {suggestions.length >
                0 && (
                className="absolute z-[999999] top-full mt-3 w-full max-h-[420px] overflow-y-auto bg-zinc-950/95 backdrop-blur-2xl border border-zinc-800 rounded-3xl z-50 shadow-[0_20px_80px_rgba(0,0,0,0.6)]">
                  {suggestions.map(
                    (
                      anime: any
                    ) => (
  ...
  searchAnime(true);
              ...
              className="bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:opacity-90 px-6 sm:px-8 py-4 rounded-2xl font-bold transition h-[58px] w-full lg:w-auto"
            >
              Search
            </button>
          </div>
  ...
  {search.trim()
    ...
    : "Popular anime trending right now"}
        ...
        {loading ? (
          ...
          <>
            <div className="grid grid-cols-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-6 lg:gap-8">
              {animeList.map(
                (
                  anime: any,
                  index: number
