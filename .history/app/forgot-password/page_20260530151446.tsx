...
if (error) {
  ...
  return; 
    ...
    <main className="min-h-screen bg-black text-white flex items-center justify-center px-6">
      ...
      <div className="relative overflow-hidden w-full max-w-md sm:max-w-md w-full min-h-[560px] rounded-[32px] border border-violet-500/20 bg-gradient-to-br from-zinc-900 via-zinc-950 to-fuchsia-950/30 p-10 shadow-[0_0_80px_rgba(168,85,247,0.12)]">
