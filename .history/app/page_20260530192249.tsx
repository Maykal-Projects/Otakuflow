          ...
          <div className="grid grid-cols-1 xl:grid-cols-[auto_1fr_auto] gap-4 lg:gap-6 max-w-7xl mx-auto w-full">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3 w-full">
              ...
              <div className="relative z-[9999] overflow-visible">
                ...
                {showGenreFilter && (
                  <div className="absolute z-[99999] top-full mt-3 left-0right-0 sm:right-auto bg-zinc-900/95 backdrop-blur-2xl border border-zinc-800 rounded-3xl p-4 sm:p-6 w-full sm:w-[500px] max-w-[95vw]">
